...
| Status          | Version       | Date       |
|-----------------|---------------|------------|
| Current build   | v0.2.0        | 15.03.2026 |
| Public launch   | v1.0-preview  | Q2 2026    |
...
**Current status:** v0.2.0 released with persistent chat sessions, Logic Exchange UX, Nyxialith OS branding, and a full UI redesign with bottom navigation. Building towards v1.0-preview.
